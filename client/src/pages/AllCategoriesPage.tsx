    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-12">
            <h1 className="text-4xl font-bold mb-4" data-testid="text-categories-title">
              Shop by Category
            </h1>
          ...
          {isLoading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {categories?.map((category) => {
                const imageUrl = category.images?.[0]?.url || "https://images.unsplash.com/photo-1483985988355-763728e1935b?w=800";
                ...
                return (
                  ...
                  >
                    <Card className="overflow-hidden hover-elevate active-elevate-2 cursor-pointer h-full">
                      ...
                      <CardContent className="p-6">
                        <h2 className="text-2xl font-bold mb-2" data-testid={`text-category-name-${category.slug}`}>
                          {category.name}
                        </h2>
